		...
		<table align="center" width="40%" height="179" id="mantenimiento">
			...
			<tr>
				...
				<td colspan="3" align="left">
					<input name="txtnombre" type="text" id="txtnombre" size="40" >				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="3" align="left">
					<input  name="txtabreviatura" type="text" id="txtabreviatura" size="10" >				</td>
		  </tr>
				<!--<tr>
...
/*			echo  " UPDATE areas SET nombre_area='".$_POST['txtnombre']."' ,
	...
	function AreasEdit($id){ 
		if(!$id){
			...
			$sql_usuarios = "SELECT * FROM usuarios where id_area='".$id."'";
			$query_usuarios= new Consulta($sql_usuarios);
